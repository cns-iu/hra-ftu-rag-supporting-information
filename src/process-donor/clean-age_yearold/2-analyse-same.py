...
def get_round_number():
    round_file = r'data\donor-meta\age_yearold\round.csv'
    try:
...
def main():
    ...
    current_file = f'data\donor-meta\age_yearold\merged_age_{round_number}.xlsx'
    previous_file = f'data\donor-meta\age_yearold\merged_age_{round_number - 1}.xlsx'
    ...
    output_same = f'data\donor-meta\age_yearold\same_{round_number}.xlsx'
    output_same_others = f'data\donor-meta\age_yearold\same-others_{round_number}.xlsx'
    output_different = f'data\donor-meta\age_yearold\age_{round_number + 1}.xlsx'
    output_different_csv = f'data\donor-meta\age_yearold\age_{round_number + 1}.csv'
