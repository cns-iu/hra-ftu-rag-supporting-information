...
file_list_dash = glob.glob('data\donor-meta\age_yearold\same-*.xlsx')
file_list_underscore = glob.glob('data\donor-meta\age_yearold\same_*.xlsx')
...
merged_df.to_excel('data\donor-meta\age_yearold\merge-all.xlsx', index=False)
merged_df.to_csv('data\donor-meta\age_yearold\merge-all.csv', index=False)
...
merge_all_df = pd.read_excel('data\donor-meta\age_yearold\merge-all.xlsx')
...
age_df.to_csv('data\donor-meta\age_yearold\age_with_tags.csv', index=False)