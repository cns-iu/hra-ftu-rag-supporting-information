...
df = pd.read_csv(r'data\scale-bar\sb-health.csv')
...
formatted_table.to_csv(r'data\vis-source-data\sf-4a-output-sb-size-cnt.csv')
...
formatted_ref.to_csv(r'data\vis-source-data\sf-4a-output-sb-ref-size-cnt.csv')
...
plt.savefig(r"vis\sf-4a-sb-health.svg", bbox_inches='tight')
# plt.show()
