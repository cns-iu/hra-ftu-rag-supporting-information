...
df = pd.read_csv(r'data\vis-source-data\4d-1-sb-test.csv') 
...
plt.savefig(r"vis\4d-1-sb-accu.svg", bbox_inches='tight')
plt.close()
...
plt.savefig(r"vis\4d-1-sb-time.svg", bbox_inches='tight')
plt.close()
