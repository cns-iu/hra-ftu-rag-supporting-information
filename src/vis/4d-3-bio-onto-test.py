...
df = pd.read_csv(r'data\vis-source-data\4d-3-bio-onto-test.csv') 
...
clean_axes(ax)
plt.tight_layout()
plt.savefig(r"vis\4d-3-bio-onto-accu.png", dpi=600, bbox_inches='tight')
plt.savefig(r"vis\4d-3-bio-onto-accu.svg", bbox_inches='tight')
plt.close()
