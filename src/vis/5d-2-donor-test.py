...
df = pd.read_csv(r'data\vis-source-data\5d-2-donor-test.csv')  
...
plt.savefig(r"vis\5d-2-donor-accu.svg", bbox_inches='tight')
plt.close()
...
plt.savefig(r"vis\5d-2-donor-time.svg", bbox_inches='tight')
plt.close()
