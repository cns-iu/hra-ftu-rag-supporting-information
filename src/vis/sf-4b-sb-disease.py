...
df = pd.read_csv(r'data\scale-bar\sb-disease.csv', encoding='latin1')
...
formatted_table.to_csv(r'data\vis-source-data\sf-4b-output-sb-size-cnt.csv')
...
formatted_ref.to_csv(r'data\vis-source-data\sf-4b-output-sb-ref-size-cnt.csv')
...
plt.savefig(r"vis\sf-4b-sb-disease.svg", bbox_inches='tight')
# plt.show()
